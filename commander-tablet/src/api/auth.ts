...
// 고정되어 있다 — 멀티테넌시 1단계로 로그인 API가 organizationCode를 요구하게 되어도,
// 화면·호출부 시그니처는 바꾸지 않고 여기서만 채운다.
const DEMO_ORGANIZATION_CODE = 'DEFAULT'

export async function login(badgeNumber: string, password: string): Promise<LoginResponse> {
