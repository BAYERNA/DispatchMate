...
export interface AdvancedFieldData { signals:any[];par:any[];routes:any[];positions:any[];zones:any[];objectives:any[];hospitals:any[];communications:any[] }
...
export const reportCommunicationHeartbeat=(id:string,body:unknown)=>notifyRequest<{effectiveState:string;lastHeartbeatAt:string}>(`/incidents/${id}/communications/heartbeat`,{method:'POST',body})
