...
초기 점검의 분석 불가 표시, 서비스 상태, 전달 이력·재시도, 세션 무효화와 안전한 초기 운영 절차는 V7~V11에 반영했다. V12는 운영 복원력·거버넌스 기능을 추가했다. 다만 이번 점검과 구현은 실서비스 사용 적합성 인증, 화재감지 정확도 인증, 외부 장비·기관 계약의 상호운용성 인증을 제공하지 않는다.
